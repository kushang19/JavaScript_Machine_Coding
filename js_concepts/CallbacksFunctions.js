...
/*
      ...
                  Blocking the main thread means long-running code prevents JavaScript from handling 
                  user interactions or rendering UI.
...
function addEventListener() {
  ...
  document.getElementById("clicked").addEventListener("click", function x() {
